...
class __TwigTemplate_87c2880eb903eaf7e937763f1399b0c0c5ef47fca6174f0cb95ddc2b29f867d7 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
($context["long"] ?? null)) ? (("filter-" . twig_replace_filter($this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, $context["item"], "id", [], "any", false, false, true, 45), 45, $this->source), ["/" => "-"]))) : (""))];
  ...
  ";
    ...
    {
        return new Source("", "core/themes/seven/templates/classy/content-edit/filter-tips.html.twig", "C:\\xampp\\htdocs\\Bhushan\\drupal-9.3.11\\core\\themes\\seven\\templates\\classy\\content-edit\\filter-tips.html.twig");
    }

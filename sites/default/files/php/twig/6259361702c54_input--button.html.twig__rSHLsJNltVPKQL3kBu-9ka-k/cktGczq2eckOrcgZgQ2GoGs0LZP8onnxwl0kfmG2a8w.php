...
class __TwigTemplate_9364345f74991801852cdeb3cf4b324260717970bf0aa8e3e2df67022c95c73f extends \Twig\Template
{
    private $source;
    private $macros = [];
...
($context["icon"] ?? null) && ($context["icon_position"] ?? null)) &&  !($context["icon_only"] ?? null))) ? (("icon-" . $this->sandbox->ensureToStringAllowed(($context["icon_position"] ?? null), 30, $this->source))) : (""))];
  ...
  ";
    ...
    {
        return new Source("", "themes/bootstrap/templates/input/input--button.html.twig", "C:\\xampp\\htdocs\\Bhushan\\drupal-9.3.11\\themes\\bootstrap\\templates\\input\\input--button.html.twig");
    }
